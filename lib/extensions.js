...
var Extensions = function (resources) {
	...
	this.init = function (appsettings) {
		 ...
		 */
			...
			extensionFilePath = path.join(path.resolve(__dirname, (lessThanNodeV6 || initial_install) ? '../../../content/config/' : '../../../node_modules/periodicjs/content/config/'), 'extensions.json');
		}
		/**
